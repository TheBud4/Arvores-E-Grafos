...
// Nesse procedimento ele retorna as palavras presentes na �rvore
// N�o imprime uma estrutura de �rvore
// Se sobrar tempo eu tento
void imprimirArvoreTRIERecursivo(Noh *noh, unsigned char *prefixo,
                                 int tamanho) {
